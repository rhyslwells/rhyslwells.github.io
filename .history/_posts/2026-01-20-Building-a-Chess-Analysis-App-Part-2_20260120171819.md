...
Where `ChessFetcher` focuses on getting data , the analyzer focuses on you guessed it...analyses. By summarising performance, identifying patterns, and producing features for visualisation and modelling.
...
Derived features are computed once at initialisation to maintain consistency across analyses. Derived columns for example are:
