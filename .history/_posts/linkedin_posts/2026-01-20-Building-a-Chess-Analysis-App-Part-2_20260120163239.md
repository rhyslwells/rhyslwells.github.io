...
Where `ChessFetcher` focuses on data acquisition, the analyzer focuses on interpretation: summarising performance, identifying patterns, and producing features for visualisation and modelling.
